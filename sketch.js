let options = ['Thumber','Turbo Putt','Stand Still','Random Disc','Eyes Closed','    Grenade','   Driver','   Midrange','Off Hand FH','Off Hand BH',' Normal BH','  Normal FH','Tomahawk', 'Roller', '360 Spin', '       Putter', 'New Mando']
let color = []
let r = 0;
let l = 1;
